...
// of the one-time seed at launch, which is about 99% of it, or because a
// player opted in since - the about and privacy pages describe both. There is
// no other source of ARAM Mayhem data.
