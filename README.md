...
**[MayhemStats.com](https://mayhemstats.com/)** - augment and champion tier lists, win rates, matchups and per-champion ideal builds, powered by games contributed by players running this app, plus a one-time seed at launch described on the site's [privacy page](https://mayhemstats.com/privacy/#seed).
